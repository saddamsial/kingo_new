...
namespace MTAssets.EasyMeshCombiner.Editor
{
    ...
    public class Menu : MonoBehaviour
    {
        ...
        static void ReadDocumentation()
        {
            EditorUtility.DisplayDialog(
                  "Read Documentation",
                  "The \"Documentation.zip\" file will open in your default application, just open the \"Documentation.html\" file to read the documentation.",
                  "Cool!");

            string filePath = Greetings.pathForThisAsset + "/Documentation.zip";
