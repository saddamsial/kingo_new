...
namespace Invector.vItemManager
{
    public class vAmmoDisplay : MonoBehaviour
    {
        ...
        [SerializeField]
        protected Text display,secundaryDisplay;        
        ...
        void Start()
        {
            ...
            display.text = "";
            if (secundaryDisplay) secundaryDisplay.text = "";
            currentAmmoId = -1;
        }
        ...
        public void Show()
        {
            ...
            if (secundaryDisplay) secundaryDisplay.gameObject.SetActive(true);
            onShow.Invoke();
        }
