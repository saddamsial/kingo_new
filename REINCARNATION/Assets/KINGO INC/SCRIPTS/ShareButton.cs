...
public class ShareButton : MonoBehaviour
{
    ...
    {
        var shareSubject = "FIND OUT YOUR PAST LIFE AND NEXT LFE WITH REINCARNATIONERS APP"; //Subject text
        var shareMessage = "Get REINCARNATIONERS from this link: " + //Message text
